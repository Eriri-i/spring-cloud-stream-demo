...
class NameProcessorApplicationTest {
    ...
    public void testUsageCostProcessor() {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
                TestChannelBinderConfiguration.getCompleteConfiguration(NameProcessorApplication.class))
            ...
            Person person = (Person) converter.fromMessage(sourceMessage, Person.class);
